  ...
  try {
    ...
    switch (scenario) {
      ...
      default:
        ...
        console.log(
          "   Valid scenarios: messageHistory, messageSend, mixed, spike, all",
        );
        process.exit(1);
    }
...
async function checkPrerequisites(): Promise<void> {
  ...
  try {
    ...
    console.warn(
      "   ⚠️  Prometheus is not accessible (metrics will be unavailable)",
    );
    console.warn(
      "      Start Prometheus with: docker-compose up -d prometheus",
    );
  }
