...
function getDatabaseMetrics() {
  ...
  return {
    ...
    activeConnections: client._activeProvider?._connectionPool?._activeConnections || 0,
    idleConnections: client._activeProvider?._connectionPool?._idleConnections || 0,
    pendingConnections: client._activeProvider?._connectionPool?._pendingConnections || 0,
  };
}
...
module.exports = {
  ...
  // Direct access to client creation (for testing)
  createPrismaClient,
  getPrismaClient,
};
